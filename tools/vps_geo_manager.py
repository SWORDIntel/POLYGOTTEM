...
"""
    ...
    def run_interactive(self):
        ...
        while True:
            options = [
                {'label': '➕ Add VPS Server', 'description': 'Add new server configuration', 'value': 'add'},
                {'label': '📋 List Servers', 'description': f'View {len(self.servers)} configured servers', 'value': 'list'},
                {'label': '📤 Export Configs', 'description': 'Generate all configuration files', 'value': 'export'},
                {'label': '✅ Verify Geolocation', 'description': 'Check IP geolocation databases', 'value': 'verify'},
                {'label': '❌ Exit', 'description': 'Exit manager', 'value': 'exit'},
            ]
